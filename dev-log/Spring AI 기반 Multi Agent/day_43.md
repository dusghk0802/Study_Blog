...
다시 644로 변경하면 파일 내용을 확인할 수 있다는 것을 실습했다.

권한을 직접 변경하고 오류가 발생하는 과정까지 확인해 보니 숫자에 따라 파일의 접근 권한이 어떻게 달라지는지 이해하기가 좀 어려웠다.
</br>특히 권한 설정이 실제 파일 사용에 바로 영향을 준다는 점이 기억에 남았다.
