...
Python의 기본 연산과 변수 사용법부터 문자열의 인덱싱·슬라이싱, 문자열
포매팅과 주요 함수까지 실습하였다. 또한 리스트의 생성, 수정, 삭제와
다양한 함수 사용법을 익히고 2차원 리스트에서 원하는 값에 접근하는 방법을
배웠다.

## 느낀점

문자열과 리스트 모두 인덱싱과 슬라이싱을 사용한다는 점이 비슷했으며,
직접 원하는 값을 추출해 보면서 인덱스의 시작 위치와 범위 지정 방법을
이해할 수 있었다.

## 나의 한 줄 평

Python의 기본 자료형과 인덱싱·슬라이싱 사용법을 실습하며 기초 문법을
익힌 하루였다.
