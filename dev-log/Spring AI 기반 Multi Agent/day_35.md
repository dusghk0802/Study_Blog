...
<p align="center">
  <img src="../../training/Spring-Boot/2026.09.04/day_35_1.PNG" alt="day_35" width="700">
</p>

실습을 진행하면서 이전에 작성한 코드와 새로 작성한 코드가 같이 있어서 어떤 부분을 실행하고 어떤 부분을 주석 처리해야 하는지 헷갈렸다. 
코드가 중복되어 실행이 제대로 되지 않는 원인을 찾는 데 시간이 오래 걸렸지만, 하나씩 주석 처리하면서 실행되는 범위를 확인해 보니 문제를 찾을 수 있었다. 
이번 실습을 통해 코드를 작성하는 것뿐만 아니라 테스트할 부분을 구분하고 이전 코드를 정리하면서 실행하는 것도 중요하다는 것을 느꼈다.
