...
```
<p align="center">
  <img src="../../training/Web/2026.08.10/results/test.JPG" alt="day_16" width="700">
</p>

처음으로 html을 해보았는데 깃허브에서 했던 것들이 부분적으로 나와서 비교적 쉽게 작성 할 수 있었다.
다만 ol type="a"에 a 또는 1, I 등 순서에 따라 </br>나열 할 수 있다는 것을 이번에 실습하면서 처음 알게 되었고, 이미지 삽입도 깃허브와 같이 파일경로로 삽입하는 방식이라 
조금 만 틀려도 이미지가 깨져서 나와서 조심해야 겠다.
</br>그리고 굵게 글자를 강조하고 싶을 때는 em을 사용하면 된다.
